...
<c:if test="${empty menuDepth}">
	...
	<nav id="main-nav" class="${param._menufix?'fixed-top':'notfixeed-top'} ${empty info.userName?'not-logged':'logged'}">
		...
		<div class="navbar navbar-javlo navbar-light navbar-expand-lg ${param._menularge?'large-menu':'small-menu'}"><div class="container-fluid">
		...
		<div class="collapse navbar-collapse justify-content-${not empty param.menuposition?param.menuposition:'end'}" id="mainNavBar">
			<div class="navbar navbar-expand-lg justify-content-${not empty param.menuposition?param.menuposition:'end'}">				
				...
				<div class="my-2 my-lg-0 search-bloc collapse-bloc">
					<button class="btn btn-outline-secondary my-2 my-sm-0 btn-sm" data-toggle="collapse" data-target="#searchForm" aria-expanded="false" aria-controls="searchForm" title="${i18n.view['global.open-search']}"><i class="bi bi-search"></i></button>
					<div id="searchForm" class="collapse">
						<div class="card card-body">
							<form id="search-form">
				            	...
				            	<button class="btn btn-outline-secondary" type="submit"><i class="bi bi-chevron-double-right"></i><span class="sr-only">${i18n.view['global.send']}</span></button>
				            	</div>
				...
				<div class="my-2 my-lg-0 login-bloc collapse-bloc">
					<button class="btn btn-outline-secondary my-2 my-sm-0 btn-sm btn-user d-none-logged" data-toggle="collapse" data-target="#loginForm" aria-expanded="false" aria-controls="loginForm" title="${i18n.view['login.nologin']}"><i class="bi bi-person-fill"></i></button>
					<button class="btn btn-outline-secondary my-2 my-sm-0 btn-sm btn-user d-logged" data-toggle="collapse" data-target="#loginForm" aria-expanded="false" aria-controls="loginForm"><i class="bi bi-person-fill"></i>-</button>
